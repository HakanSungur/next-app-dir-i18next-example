          ...
          >
            ...
            <div className="flex-grow">
              <span className="block xl:text-lg font-semibold">
                {totalGuests || ""} {t("guestsInput1")}
              </span>
              <span className="block mt-1 text-sm text-neutral-900 leading-none font-light">
                {totalGuests ? t("guestsInput1") : t("guestsInput2")}
              </span>
              {!!totalGuests && open && (
                <ClearDataButton
                  onClick={() => {

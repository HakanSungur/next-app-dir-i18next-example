...
const LocationInput = ({
  ...
  let recentSearchArray = shuffle(
    dropDownData?.map((x) => x?.name).filter((_, i) => i < 260)
  );
    ...
    <div className={`relative flex ${className}`} ref={containerRef}>
      ...
      >
        ...
        <div className="flex-grow">
          <input
            className={`form-control block w-full bg-transparent border-none focus:ring-0 p-0 focus:outline-none focus:placeholder-neutral-300 xl:text-lg font-semibold placeholder-neutral-800 dark:placeholder-neutral-200 truncate`}
          ...
          <span className="block mt-0.5 text-sm text-neutral-900 font-light ">

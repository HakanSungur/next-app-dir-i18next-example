...
const RentalCarDatesRangeInput = ({
  defaultDateValue,
  defaultTimeValue,
  onChange,
  defaultFocus = null,
  ...
  useEffect(() => {
    setStateTimeRage(defaultTimeValue);
  }, [defaultTimeValue]);
          ...
          <div className="inline-flex items-center text-base xl:text-lg font-semibold">
            <span className="flex-shrink-0">
              {stateDate?.endDate
                ...
                : t("rentalCarDatesRangeInput3")}
            </span>
            {stateDate?.endDate && renderEditTime("dropOff")}
          </div>
          <span className="block mt-1 text-sm text-neutral-400 font-light leading-none">
            {stateDate?.endDate ? t("rentalCarDatesRangeInput3") : t("rentalCarDatesRangeInput2")}
          </span>
